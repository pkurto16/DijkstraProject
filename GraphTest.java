...
class GraphTest {
	...
	void addTestWithAdjList() {
		...
		assertEquals(arrToString(null), arrToString(testGraph.getAdjacencyList(2)));
		assertEquals(arrToString(new int[] { 4 }), arrToString(testGraph.getAdjacencyList(3)));
		assertEquals(arrToString(null), arrToString(testGraph.getAdjacencyList(4)));
		...
		assertEquals(arrToString(new int[] { 3 }), arrToString(testGraph.getAdjacencyList(8)));
	}
	...
	void degreeTest() {
		...
		assertEquals(0, testGraph.degree(2));
		assertEquals(1, testGraph.degree(3));
		assertEquals(0, testGraph.degree(4));
		assertEquals(1, testGraph.degree(5));
		assertEquals(0, testGraph.degree(7));
		assertEquals(1, testGraph.degree(8));
	}
	...
	void containsEdgeTest() {
		...
		assertFalse(testGraph.containsEdge(new Edge(3, 1)));
